package com.example.biodatacoba;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void alamat(View v) {
        Uri location = Uri.parse("geo:0,0?q=Ketanggungan, Kecamatan Ketanggungan, Kabupaten Brebes, Jawa Tengah 52263");
        Intent it = new Intent(Intent.ACTION_VIEW, location);
        startActivity(it);
    }

    public void telpon(View v) {
        String no = "085640748658";
    ...
    public void email(View v){
        Intent it = new Intent(Intent.ACTION_SENDTO,
                Uri.fromParts("mailto", "111202113705@mhs.dinus.ac.id", null));
